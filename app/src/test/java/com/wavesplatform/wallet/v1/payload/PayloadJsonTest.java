...
public class PayloadJsonTest {
    ...
    public void assetBalance() {
        ...
        Gson gson = new Gson();
        com.wavesplatform.sdk.net.model.response.AssetBalance ab = gson
                .fromJson(abJson, com.wavesplatform.sdk.net.model.response.AssetBalance.class);
    ...
    public void assetBalances() {
        ...
        Gson gson = new Gson();
        com.wavesplatform.sdk.net.model.response.AssetBalances abs = gson
                .fromJson(abJson, com.wavesplatform.sdk.net.model.response.AssetBalances.class);
