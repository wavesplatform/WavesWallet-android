...
public class PayloadJsonTest {
    ...
    public void assetBalance() {
        ...
        Gson gson = new Gson();
        com.wavesplatform.sdk.model.response.AssetBalance ab = gson
                .fromJson(abJson, com.wavesplatform.sdk.model.response.AssetBalance.class);
    ...
    public void assetBalances() {
        ...
        Gson gson = new Gson();
        com.wavesplatform.sdk.model.response.AssetBalances abs = gson
                .fromJson(abJson, com.wavesplatform.sdk.model.response.AssetBalances.class);
