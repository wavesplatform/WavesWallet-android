...
public class CommissionTest {
    ...
    public void checkCommissions() {
        ...
        assertEquals(900000L, Companion.countCommission(commission, params));
        ...
        params.setSmartAsset(true);
        params.setTransfersCount(1);
        assertEquals(600000L, Companion.countCommission(commission, params));
        ...
        assertEquals(300000L, Companion.countCommission(commission, params));
