...
class TradeBuyFragment : BaseFragment(), TradeBuyView {
    ...
    override fun onViewReady(savedInstanceState: Bundle?) {
        text_expiration_value.click {
            ...
            alt_bld.setTitle(getString(R.string.buy_expiration_dialog_title))
            ...
            alt_bld.setPositiveButton(getString(R.string.buy_expiration_dialog_positive_btn),
                    { dialog, which ->
                        dialog.dismiss()
            ...
            alt_bld.setNegativeButton(getString(R.string.buy_expiration_dialog_negative_btn),
