...
import com.wavesplatform.sdk.model.response.node.AssetPairResponse
...
open class AssetPairDb(
    ...
    constructor(alias: AssetPairResponse?) : this() {
        alias.notNull {
    ...
    fun convertFromDb(): AssetPairResponse {
        return AssetPairResponse(
