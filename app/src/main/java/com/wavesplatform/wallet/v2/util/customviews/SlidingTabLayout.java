...
/**
 * Custom realization of SlidingTabLayout with indicator gravity = bottom|start & width = 14dp,
 * look original at com.flyco.tablayout.SlidingTabLayout. Changes at lines #507-514
 */
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorGravity == Gravity.BOTTOM) {
                    // Custom design with indicator gravity = bottom|start & width = 14dp
                    mIndicatorDrawable.setBounds(
                            paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                            height - (int) mIndicatorHeight - (int) mIndicatorMarginBottom,
                            paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left + dp2px(14),
                            height - (int) mIndicatorMarginBottom);
                    // End custom design with indicator gravity = bottom|start & width = 14dp
                } else {
                    mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
