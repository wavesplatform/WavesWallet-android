...
object Constants {
    ...
    val defaultAssets = listOf<AssetBalance>(
            AssetBalance("", quantity = 10000000000000000L, isFavorite = true, issueTransaction = IssueTransaction(name = "Waves", decimals = 8), isGateway = true, isWaves = true),
            ...
            AssetBalance("Gtb1WRznfchDnTh37ezoDTJ4wcoKaRsKqKjJjy7nm2zU", quantity = 100000000000, issueTransaction = IssueTransaction(assetId = "Gtb1WRznfchDnTh37ezoDTJ4wcoKaRsKqKjJjy7nm2zU", id = "Gtb1WRznfchDnTh37ezoDTJ4wcoKaRsKqKjJjy7nm2zU", name = "Euro", decimals = 2), isFiatMoney = true, isGateway = true),
            AssetBalance("HZk1mbfuJpmxU1Fs4AX5MWLVYtctsNcg6e2C6VKqK8zk", quantity = 8400000000000000, issueTransaction = IssueTransaction(assetId = "HZk1mbfuJpmxU1Fs4AX5MWLVYtctsNcg6e2C6VKqK8zk", id = "HZk1mbfuJpmxU1Fs4AX5MWLVYtctsNcg6e2C6VKqK8zk", name = "Litecoin", decimals = 8), isGateway = true),
            AssetBalance("BrjUWjndUanm5VsJkbUip8VRYy6LWJePtxya3FNv4TQa", quantity = 2100000000000000, issueTransaction = IssueTransaction(assetId = "BrjUWjndUanm5VsJkbUip8VRYy6LWJePtxya3FNv4TQa", id = "BrjUWjndUanm5VsJkbUip8VRYy6LWJePtxya3FNv4TQa", name = "Zcash", decimals = 8), isGateway = true),
            AssetBalance("zMFqXuoyrn5w17PFurTqxB7GsS71fp9dfk6XFwxbPCy", quantity = 2100000000000000, issueTransaction = IssueTransaction(assetId = "zMFqXuoyrn5w17PFurTqxB7GsS71fp9dfk6XFwxbPCy", id = "zMFqXuoyrn5w17PFurTqxB7GsS71fp9dfk6XFwxbPCy", name = "Bitcoin Cash", decimals = 8), isGateway = true),
            AssetBalance("2mX5DzVKWrAJw8iwdJnV2qtoeVG9h5nTDpTqC1wb1WEN", quantity = 100000000, issueTransaction = IssueTransaction(assetId = "2mX5DzVKWrAJw8iwdJnV2qtoeVG9h5nTDpTqC1wb1WEN", id = "2mX5DzVKWrAJw8iwdJnV2qtoeVG9h5nTDpTqC1wb1WEN", name = "TRY", decimals = 3), isFiatMoney = true, isGateway = true),
