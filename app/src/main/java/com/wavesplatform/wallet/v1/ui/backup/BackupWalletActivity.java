...
public class BackupWalletActivity extends BaseAuthActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isBackedUp()) {
            startFragment(com.wavesplatform.wallet.v1.ui.backup.BackupWalletCompletedFragment.newInstance(false), com.wavesplatform.wallet.v1.ui.backup.BackupWalletCompletedFragment.TAG);
        } else {
            startFragment(new com.wavesplatform.wallet.v1.ui.backup.BackupWalletStartingFragment(), BackupWalletStartingFragment.TAG);
        }
    }
