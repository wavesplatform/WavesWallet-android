...
import com.wavesplatform.wallet.v1.util.PasswordUtil;
import com.wavesplatform.wallet.v1.util.annotations.Thunk;

import static com.wavesplatform.wallet.v1.ui.auth.PinEntryViewModel.KEY_INTENT_CREATE_NEW_PIN;
...
public class PasswordWalletActivity extends BaseAuthActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.commandNext.setOnClickListener(v -> {
            ...
            if (!com.wavesplatform.wallet.v1.util.StringUtils.isValidName(em)) {
